export const REVIEWS = [
  {
    name: "Mamta Bhandari",
    rating: 5,
    text: "I had a wonderful experience at your jewellery store. The collection is elegant, and the craftsmanship of each piece is excellent. The staff were patient, friendly, and guided me well without being pushy.",
    time: "6 months ago"
  },
  {
  ...
  {
    name: "Nitika Bhardwaj",
    rating: 5,
    text: "Good service. Latest designs. I got some extra gifts with the buy of gold like Milton bottle, my birthday cake, a thank you card with dairy milk. Best marketing!",
    time: "6 months ago"
  },
  {
  ...
  },
  {
    name: "Yogini Aisha",
    rating: 5,
    text: "I recently purchased diamond studs from the shop. Stunning jewellery piece, quality is top notch. Designs are breathtaking, highly recommended.",
    time: "9 months ago"
  },
  {
    name: "Surendra Singh",
  ...
  {
    name: "Anuradha Thapliyal",
    rating: 5,
    text: "Must visit for great quality gold and silver ornaments. Recently purchased a gold chain and a beautiful kitty set and everyone liked the design.",
    time: "a year ago"
  }
];
